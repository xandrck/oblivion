class StoragesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @storage.save
        format.html { redirect_to @storage, notice: 'Хранилище успешно создано.' }
  ...
  def update
    respond_to do |format|
      if @storage.update(storage_params)
        format.html { redirect_to @storage, notice: 'Хранилище успешно обновлено.' }
  ...
  def destroy
    @storage.destroy
    respond_to do |format|
      format.html { redirect_to storages_url, notice: 'Хранилище успешно удалено.' }
